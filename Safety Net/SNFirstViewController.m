...
-(void)getShitStarted{
    ...
    NSLog(@"latitude %+.6f, longitude %+.6f\n",
          _locationMgr.location.coordinate.latitude,
          _locationMgr.location.coordinate.longitude);
    _lon=[NSString stringWithFormat:@"%f", _locationMgr.location.coordinate.longitude];
    _lat=[NSString stringWithFormat:@"%f", _locationMgr.location.coordinate.latitude];
    self.longCord.text=_lat;
    self.latCord.text=_lon;
...
- (void)peripheralManager:(CBPeripheralManager *)peripheral central:(CBCentral *)central didSubscribeToCharacteristic:(CBCharacteristic *)characteristic
{
    ...
    // Get the data
    self.dataToSend = [@"testing 123" dataUsingEncoding:NSUTF8StringEncoding];
...
- (void)centralManagerDidUpdateState:(CBCentralManager *)central
{
    ...
    NSLog(@"central configured; scanning");
    // ... so start scanning
    [self scan];
...
- (void)centralManager:(CBCentralManager *)central didDisconnectPeripheral:(CBPeripheral *)peripheral error:(NSError *)error
{
    ...
    localNotification.alertBody = @"Someone's in danger nearby!";
